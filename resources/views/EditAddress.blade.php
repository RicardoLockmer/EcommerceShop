        ...
        <div class="myForms" style="width: 35em; margin-left: 26%; border: 2px solid #007bff">
            <div class="myFormData">
                ...
                <div class="newbiz ">
                    ...
                    <div class="control">
                        <input class="form-control @error('nombreCompleto') is-invalid @enderror" name="nombreCompleto"
                            id="nombreCompleto" type="text" placeholder="{{$address->nombreCompleto}}"
                            value="{{$address->nombreCompleto}}" maxlength="120">
                ...
                <div class='row'>
                    ...
                    <div class="newbiz col">
                        ...
                        <input class="form-control @error('codigoPostal') is-invalid @enderror" type="text"
                            ...
                            maxlength="5" name="codigoPostal" value="{{$address->codigoPostal}}"
                            placeholder="{{$address->codigoPostal}}">
                        <small class="text-muted text-wrap">Conseguir mi <a href="https://correos.go.cr/codigo-postal/"
                                target="_blank">Código Postal</a></small>
                ...
                <div class="newbiz ">
                    ...
                    <div class="control">
                        <input class="form-control @error('dir') is-invalid @enderror" name="dir" id="dir" type="text"
                            placeholder="{{$address->direccion}}" value="{{$address->direccion}}">

                    </div>
                </div>
                <br>
                <div class="newbiz ">
                    <label class="" for="infoAdicional"><strong>Información Adicional</strong> <a class="text-muted"
                    ...
                    <div class="control">
                        <textarea class="form-control @error('infoAdicional') is-invalid @enderror" name="infoAdicional"
                            id="infoAdicional" placeholder="Información adicial que nos ayude a encontrar la Dirección."
                            value="{{$address->infoAdicional}}">  </textarea>
                ...
                <div class="row">
                    <div class="newbiz col-2" style="margin-right: 8px!important;">
                        <input style="width:66px!important; " class="form-control @error('prefix') is-invalid @enderror"
                            id="prefix" type="tel" placeholder="+506" value="+506" disabled> <input name="prefix"
                            value="+506" hidden>
                    </div>


                    <div class="newbiz ">
                        <input class="form-control col @error('phoneNumber') is-invalid @enderror" name="phoneNumber"
                            id="phoneNumber" type="tel" pattern="[0-9]{4}[0-9]{4}"
                            placeholder="{{$address->phoneNumber}}" value="{{$address->phoneNumber}}">
                    </div>
                </div>
                <br>
