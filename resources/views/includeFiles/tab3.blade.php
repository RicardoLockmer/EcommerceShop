    ...
    <div class="">
        ...
        <div class="newbiz " style="margin: 0 8px 0 0;  ">
            <div class="control">
                ...
                <a  style="margin-left: 8px;" class="text-muted" title="Si tiene otro tamaño del mismo color agregar otra fila con Unidad, Tamaño, Cantidad y Precio para este color" data-toggle="tooltip" data-placement="right" data-original-title="Tamaño del producto en este color" >
