<!-- <div class="my-4">
    ...
    <ul class="list-inside list-disc mt-4">
        ...
        <li class="text-gray-500 text-sm">Ejemplo: Una Camisa Roja puede tener tamaño Pequeño, Mediano y Grande</li>
...
<div  class="mt-4" v-for="(variante, mainIndex) in variantes">
                ...
                <div class="font-bold mb-2">
                  @{{variante.unidad}}  @{{ mainIndex+1 }}. @{{ variante.color }}
                </div>
        
           
                <span v-if="variante.sizes[0].unidad != 'NoAplica'" class="cursor-pointer justify-center w-full my-4 py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-yellow-400 hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500"  style="margin-bottom:15px;margin-top:15px;"   @click="addSize(mainIndex)">
                    
                    Agregar Otro Tamaño +
                    
                </span>
           
                <span v-else style="margin-bottom:15px;margin-top:18px; margin-left:12px; border: 1px solid green;border-radius: 3px; padding: 3px 6px 3px 6px">
                    Especifique la Cantidad de Inventario y el Precio
                </span>
        ...
        <div class="col-span-12 grid grid-cols-11 lg:grid-cols-12 gap-3 py-4" style="">
            ...
            <div class="col-span-4 lg:col-span-3" style="">
                    ...
                    <small for="price" class="flex items-center text-sm font-medium text-gray-700">
                        ...
                        <a v-if="index == 0" class="text-muted ml-2" title="Precio del Prodcto por Unidad" data-toggle="tooltip" data-placement="right" data-original-title="Precio de este color/tamaño" >
                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-question-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" d="M14 1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z" />
                                <path d="M5.255 5.786a.237.237 0 0 0 .241.247h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286zm1.557 5.763c0 .533.425.927 1.01.927.609 0 1.028-.394 1.028-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94z" />
                            </svg>
