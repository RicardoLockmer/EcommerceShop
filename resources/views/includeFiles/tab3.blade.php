        ...
        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-question-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="col-span-4 lg:col-span-3" style="">
                    ...
                    <div class="relative rounded-md shadow-sm">
                        ...
                        <input type="text"  v-model="variante.sizes[index].precio"  name="price" id="price" class="@error('price') is-invalid @enderror focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-7 pr-12 sm:text-sm border-gray-300 rounded-md form-control" placeholder="0.00">
