    ...
    <ul class="list-inside list-disc mt-4 mb-4">
    ...
    <div class='w-full' >
        ...
        <div class="border-b border-gray-300">
            ...
            <div v-if="allCRChecked" :class="(todoGratis)? '  flex items-center mb-4 ' : 'flex items-center  mb-4  '" >
                ...
                <div class="text-gray-700 font-bold text-sm" for="Gratis"  >Todo Envio Gratis</div>
...
<div v-on:click="activePreset" class="border w-1/2 rounded-md centerMyImages p-2 cursor-pointer shadow-md mt-5 hover:bg-gray-200">
    Guardar para otros productos
</div>
