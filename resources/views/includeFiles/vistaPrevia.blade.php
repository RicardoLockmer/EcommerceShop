...
<div v-if="vistaPrevia" class="border-l border-gray-300 ml-8 pl-8 col-start-6 col-end-12 " >
        <div class="h-auto pl-6">
            ...
            <span class="flex items-center" style="font-size: 26px;" > <strong>Vista Previa</strong> 
            <small>
            <!-- <a class="text-muted mt-2" data-toggle="tooltip" data-placement="right" title="Al agregar algo en el formulario se actualiza en la vista previa. ">
...
<p>
<small class="text-muted">Al agregar algo en el formulario se actualiza en la vista previa. </small>
</p>
            {{-- START --}}
