                    ...
                    <div class="newbiz col">
                        ...
                        <div class="control">
                            <input class="form-control @error('primerNombre') is-invalid @enderror" name="primerNombre"
                                id="primerNombre" type="text" placeholder="{{$store->primerNombre}}">
                        </div>
                    </div>
                ...
                <div class="newbiz ">
                    ...
                    <div class="control">
                        <input class="form-control @error('cedulaJuridica') is-invalid @enderror" name="cedulaJuridica"
                            id="cedulaJuridica" type="text" placeholder="{{$store->cedulaJuridica}}" maxlength="10"
                    ...
                    <div class="control ">
                        <div class="select">
                            ...
                            <select class="form-control" name="tipoNegocio">
                                ...
                                <option class="text-muted" style="background-color:rgba(233, 233, 233, 0.301)" selected
                                    disabled>
                                    {{$store->tipoNegocio}}
                                </option>
                ...
                <div class="newbiz ">
                    ...
                    <div class="control">
                        <input class="form-control @error('BizE') is-invalid @enderror" name="BizE" id="BizE"
                            type="text" placeholder="{{$store->email}}" value="{{old('BizE')}}">
                ...
                <div class="newbiz ">
                    ...
                    <div class="control">
                        <input class="form-control @error('dir') is-invalid @enderror" name="dir" id="dir" type="text"
                            placeholder="{{$store->direccion}}" value="{{old('dir')}}">
                ...
                <div class="row">
                    <div class="newbiz col-2" style="margin-right: 8px!important;">
                        <input style="width:66px!important; " class="form-control @error('prefix') is-invalid @enderror"
                            id="prefix" type="tel" placeholder="+506" value="+506" disabled>
                    </div>


                    <div class="newbiz ">
                        <input class="form-control col @error('ntel') is-invalid @enderror" name="ntel" id="ntel"
                            type="tel" pattern="[0-9]{4}[0-9]{4}" placeholder="{{$store->phoneNumber}}"
                            value="{{old('ntel')}}">
                    </div>
                </div>
