...
<div class="container">
    ...
    <div class='container'>
        <div class="centerMyImages">
            ...
            <a href="/negocio/{{$user->store->nombreNegocio}}/editar" class='column myProduct btn centerMyImages'
                style="border: 1px solid rgb(192, 192, 192);">
                Visitar Negocio
            </a>
            @else
            <a href="/iniciar-mi-negocio" class='column myProduct btn centerMyImages'
                style="border: 1px solid rgb(192, 192, 192);">
                Crear Negocio
            </a>
            @endif
    ...
    <div class='container' style="">
        <div class="centerMyImages">
            ...
            <a href="/perfil/{{$user->name}}/direcciones" class='column myProduct btn centerMyImages'
                style="border: 1px solid rgb(192, 192, 192);">
                Editar Direcciones
            </a>
