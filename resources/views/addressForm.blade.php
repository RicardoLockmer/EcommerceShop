            ...
            <div class="col" style="width: 45%; height: auto; margin: 1.9em 0 0 0; " >
                <div class="card-body" style="padding-left: 0; "> 
                    ...
                    <div class="form-row d-flex d-flex flex-wrap justify-content-center">
                        ...
                        <small style="font-size:12px; position: absolute; bottom: 15px; right:15px;"><strong></strong><svg style="font-size: 23px;" width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-file-check text-success" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
