        ...
        <div class="col" style="width: 45%; height: auto; margin: 1.9em 0 0 0; ">
            <div class="card-body" style="padding-left: 0; ">
                ...
                <div class="form-row d-flex d-flex flex-wrap justify-content-center">
                    ...
                    <a href="/perfil/{{$user->name}}/direcciones/agregar"
                        class="addAddress addressBox p-2 card centerMyImages text-muted"
                        style="border: 2px dashed rgb(180, 180, 180)!important;">
                        <div class="justify-content-center ">
                            <svg style="font-size:55px;" width="1em" height="1em" viewBox="0 0 16 16"
                    ...
                    <div class="addressBox p-2 text-muted"
                        style="position: relative; border: 1px solid #007bff!important;box-shadow: 0 0.5rem 1rem rgba(0, 0, 0, .15)">
                        ...
                        <small style="font-size:12px; position: absolute; bottom: 15px; right:15px;">
                            <svg style="font-size: 23px;" width="1em" height="1em" viewBox="0 0 16 16"
                                class="bi bi-file-check text-success" fill="currentColor"
                        ...
                        <form action="/perfil/{{$direccion->id}}/delete" method="POST">
                            ...
                            <button type="submit" class="btn "
                                style="margin: 0 1em 0 0; position: absolute; bottom:15px; left: 15px"
                                onclick="return confirm('Esta a seguro de Borrar Esta Dirrección?')">
                        ...
                        <form action="/perfil/{{$direccion->id}}/editar" method="GET">
                            @csrf
                            <button type="submit" class="btn buttonHoverEDIT"
                                style="margin: 0 1em 0 0; position: absolute; bottom:15px; left: 85px">
                                Editar
                            </button>
                        </form>
                    </div>
