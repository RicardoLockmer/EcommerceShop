...
<div class="container">
    ...
    {{-- NEW ITEM FORM START --}}
    <form action="/negocio/{{$store->nombreNegocio}}/{{$item->id}}/editar" method="POST" class="forms"
            ...
            <div class="myFormData">
                    ...
                    <div class="newbiz" style="margin: 0 0 0 0;">
                        ...
                        <div class="control">
                            <input class="form-control @error('nombre') is-invalid @enderror" name="nombre" id="nombre"
                                type="text" placeholder="Nombre del Producto" value="{{$item->nombre}}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-row ">
                    <span class="file-name col centerMyImages" style='height:100px; width: 70px; text-align:center;'>
                        <img src="{{ Storage::URL('storage/assetItems/'.$item->image) }}" id="image"
                            style='height:90px;' />
                    </span>
                    <span class="file-name col centerMyImages" style='height:100px; text-align:center;'>
                        <img src="{{ Storage::URL('storage/assetItems/'.$item->image2) }}" id="image2"
                            style='height:90px;' />
                    </span>
                    <span class="file-name col centerMyImages" style='height:100px; text-align:center;'>
                        <img @if ($item->image3) src="{{ Storage::URL('storage/assetItems/'.$item->image3) }}" @endif
                        id="image3" style='height:90px;' />
                    </span>
                    <span class="file-name col centerMyImages" style='height:100px; text-align:center;'>
                        <img @if ($item->image4) src="{{ Storage::URL('storage/assetItems/'.$item->image4) }}" @endif
                        id="image4" style='height:90px;' />
                    </span>
                    <span class="file-name col centerMyImages" style='height:100px; text-align:center;'>
                        <img @if ($item->image5) src="{{ Storage::URL('storage/assetItems/'.$item->image5) }}" @endif
                        id="image5" style='height:90px;' />
                    </span>
                    <span class="file-name col centerMyImages" style='height:100px; text-align:center;'>
                        <img @if ($item->image6) src="{{ Storage::URL('storage/assetItems/'.$item->image6) }}" @endif
                        id="image6" style='height:90px;' />
                    </span>
                </div>
                {{-- DESCRIPCION --}}
                <div class="newbiz" style="margin: 0 0 0 0;">
                    ...
                    <div class="control">
                        ...
                        <textarea class="textarea form-control @error('descripcion') is-invalid @enderror"
                            ...
                            value="{{$item->descripcion}}">{{$item->descripcion}}</textarea>
                    </div>
                </div>
                <br>
                    ...
                    <div class="newbiz col" style="margin: 0 0 0 0;">
                        <div class="control">
                            ...
                            <input class="form-control @error('cantidad') is-invalid @enderror" name="cantidad"
                                id="precio" type="number" min="1" placeholder="Cantidad" value="{{$item->cantidad}}">
                        </div>
                    </div>
                </div>
                <br>
