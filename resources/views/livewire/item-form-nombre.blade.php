<div>
    <div>
        <div class="newbiz" style="margin: 0 0 0 0;">
            ...
            <div class="control">
                <input class="form-control @error('nombre') is-invalid @enderror" name="nombre" id="nombre" type="text" placeholder="Nombre del Producto" value="{{ old('nombre') }}" maxlength="{{ $nameMax }}" wire:keyup="nameCounter" wire:model="nameWords">
            </div>
            <p class="text-muted">{{ $nameCounter }}/ {{ $nameMax }}</p>
        </div>
    </div>
    <br>
</div>
