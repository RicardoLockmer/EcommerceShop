  ...
  <div class="row">
    ...
    <div class="col " style="margin: 3em 0 0 1em; width: 100%;  ">
      ...
      <a class="magnifier-thumb-wrapper" id="sticky">
        <img class="img-thumbnail mainImage" style="width: 100% ; margin-bottom: 15px; " data-toggle="magnify"
          id="thumb" data-magnify-src="{{ Storage::URL('storage/assetItems/'.$item->image) }}"
          src="{{ Storage::URL('storage/assetItems/'.$item->image) }}" alt="{{$item->nombre}}">
      </a>
    </div>
    {{-- COLUMNA DEL INFO --}}
    <div class="col-6" style="margin: 3em 0 0 0;">
      <article style="margin: 0 0 1em 0">
        ...
        @for($i = 1; $i < 6; $i++) <svg width="1em" style="color: rgb(245, 210, 12); font-size: 12px; " height="1em"
          viewBox="0 0 16 16" class="bi bi-star-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          <path
          ...
          <div class="content">
            ...
            <div id="ENVI">
              ...
              <p class="card-text" style="position: aboslute; bottom:0; right:0;">
                ...
                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-box-seam text-muted" fill="currentColor"
...
<div class="myFirstSectionInner scroll" style="border-top: 1px solid grey; border-bottom: 1px solid grey; height: 7em;">
  <div class="container is-fluid" style=" padding: 15px 0 15px 0;">
    <div class="noWrap">
      ...
      @if($image != NULL)
      <img id="subimage" class="sectionImage subimage" src="{{ Storage::URL('storage/assetItems/'.$image) }}"
        alt="{{$item->nombre}}">
      @endif
...
@if($item->Specs)
<div class="form-row "
  style="border-top: 1px solid rgb(180, 180, 180); width: 100%; height: auto; min-height: 250px;margin: 0 0 0 0.5em">
...
@if($item->Specs)
<div class="form-row "
  style="border-top: 1px solid rgb(180, 180, 180); width: 100%; height: auto; min-height: 250px;margin: 3em 0 0 0.5em">
              ...
              <div class="noWrap">
                ...
                <div class="myCards">
                  <div class="card-block">
                    ...
                    <a href="{{$moreitem->store->nombreNegocio}}/productos/{{$moreitem->id}}"><img
                        class="sectionImage2 " src="{{ Storage::URL('/storage/assetItems/'.$moreitem->image) }}"
                        alt=""></a>
                  </div>
                </div>
                @endforeach
