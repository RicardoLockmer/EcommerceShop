...
<div class="container">
    ...
    {{-- NEW ITEM FORM START --}}
    <form action="/negocio/{{$store->nombreNegocio}}/nuevo-producto" method="POST" class="forms"
            ...
            <div class="myFormData">
                ...
                <div>
                    <div class="newbiz" style="margin: 0 0 0 0;">
                        ...
                        <div class="control">
                            <input class="form-control @error('nombre') is-invalid @enderror" name="nombre" id="nombre"
                                type="text" placeholder="Nombre del Producto" value="{{old('nombre')}}" maxlength="25">
                        </div>
                    </div>
                </div>
                ...
                <div class='form-row' style="width: auto;">
                    ...
                    <div class="newbiz col">
                        <div class="custom-file">
                            <input class="custom-file-input 
                        @error('image2') is-invalid @enderror" type="file" name="image2"
                ...
                <div class='form-row' style="width: auto;">
                    ...
                    <div class="newbiz col">
                        <div class="custom-file">
                            <input class="custom-file-input 
                        @error('image3') is-invalid @enderror" type="file" name="image3"
                    ...
                    <div class="newbiz col">
                        <div class="custom-file">
                            <input class="custom-file-input 
                        @error('image4') is-invalid @enderror" type="file" name="image4"
                ...
                <div class='form-row' style="width: auto;">
                    ...
                    <div class="newbiz col">
                        <div class="custom-file">
                            <input class="custom-file-input 
                        @error('image5') is-invalid @enderror" type="file" name="image5"
                    ...
                    <div class="newbiz col">
                        <div class="custom-file">
                            <input class="custom-file-input 
                        @error('image6') is-invalid @enderror" type="file" name="image6"
                ...
                <div class="newbiz" style="margin: 0 0 0 0;">
                    ...
                    <div class="control">
                        ...
                        <textarea class="textarea form-control @error('descripcion') is-invalid @enderror"
                            name="descripcion" id="descripcion" type="text" placeholder="Describa su Producto"
                            maxlength="255" value="{{old('descripcion')}}"></textarea>
                    </div>
                </div>
                <br>
                    ...
                    <div class='row' style="width: auto;">
                        ...
                        <div class="newbiz col" style="margin: 0 0 0 0;">
                            <div class="control">
                                ...
                                <input class="form-control @error('marca') is-invalid @enderror" name="marca" id="marca"
                                    type="text" placeholder="Marca del Producto" value="{{old('marca')}}">
                            </div>
                        </div>
                        ...
                        <div id="colors" class="newbiz col" style="margin: 0 0 0 0;">
                            <div class="control">
                                ...
                                <div class="select">
                                    <select name="color" class="custom-select @error('color') is-invalid @enderror"
                                        onchange="otherColor(this.options[this.selectedIndex].value)">
                ...
                <div class='row' style="width: auto;">
                    <div class="newbiz col" style="margin: 0 0 0 0;">
                        <div class="control">
                            ...
                            <input class="form-control @error('precio') is-invalid @enderror" name="precio" id="precio"
                                type="number" min="100" step="any" placeholder="&#8353; Colón Costarricense"
                                value="{{old('precio')}}">
                        </div>
                    </div>
                    ...
                    <div class="newbiz col" style="margin: 0 0 0 0;">
                        <div class="control">
                            ...
                            <input class="form-control @error('cantidad') is-invalid @enderror" name="cantidad"
                                id="precio" type="number" min="1" placeholder="Cantidad" value="{{old('cantidad')}}">
                        </div>
                    </div>
                </div>
                <br>
                ...
                <div class="row">
                    <div class="newbiz col-5" style="margin: 0 0 1.5em 0;">
                        <div class="control">
                            ...
                            <input class="form-control myspecKey @error('myspec') is-invalid @enderror" type="text"
                                placeholder="ej. Modelo" value="{{old('myspec')}}">
                    ...
                    <div class="newbiz col-5" style="margin: 0 0 1.5em 0;">
                        <div class="control">
                            ...
                            <input class="form-control myspecVal @error('myspec') is-invalid @enderror" type="text"
                                placeholder="ej. Modelo 2020" value="{{old('myspec')}}">
                        </div>
                    </div>
                ...
                <div>
                    <div class="newbiz" style="margin: 0 0 0 0;">
                        ...
                        <div class="control">
                            <input class="form-control @error('empresa') is-invalid @enderror" name="empresa"
                                id="empresa" type="text" placeholder="Ej. Correos de Costa Rica"
                                value="{{old('empresa')}}">
                        </div>
                    </div>
                </div>
                ...
                <div class='row' style="width: auto;">
                    <div class="newbiz col" style="margin: 0 0 0 0;">
                        <div class="control">
                            ...
                            <input class="form-control @error('peso') is-invalid @enderror" name="peso" id="peso"
                                type="number" step="any" placeholder="Ej. 250" value="{{old('peso')}}">
                        </div>
                    </div>
                    ...
                    <div class="newbiz col" style="margin: 0 0 0 0;">
                        <div class="control">
                            ...
                            <input class="form-control @error('dimensiones') is-invalid @enderror" name="dimensiones"
                                placeholder="Ej. 25x10x15" value="{{old('dimensiones')}}">
                        </div>
                    </div>
                </div>
                <br>
                <div class='row' style="width: auto;">
                    <div class="newbiz col" style="margin: 0 0 0 0;">
                        <div class="control">
                            ...
                            <input class="form-control @error('tiempoEntrega') is-invalid @enderror"
                                name="tiempoEntrega" id="tiempoEntrega" type="number" min="1" step="any"
                                placeholder="Ej. 1" value="{{old('tiempoEntrega')}}">
                        </div>
                    </div>
                    ...
                    <div class="newbiz col" style="margin: 0 0 0 0;">
                        <div class="control">
                            ...
                            <input class="form-control @error('precioEnvio') is-invalid @enderror" name="precioEnvio"
                                type="number" min="0" placeholder="Ej. 600" value="{{old('precioEnvio')}}">
                        </div>
                    </div>
                </div>
                <br>
