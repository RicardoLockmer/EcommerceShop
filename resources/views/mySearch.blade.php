    ...
    <div style="margin: 2.3em 0 0 0; border-bottom: 2px solid rgba(184, 184, 184, 0.384) ">
        ...
        <div class="card mb-3"
            ...
            <div class="row no-gutters">
                ...
                <div class="col-md-2 centerMyImages"
                    style="min-height: 160px; margin: 0 1.5em 0 1.5em; max-height: auto">
                ...
                <div class="col-md-8">
                    <div class="card-body" style="padding: 0 0 0 1em;">
                        ...
                        {{-- STAR RATING LOOP --}}
                        @for($i = 1; $i < 6; $i++) <svg width="1em" style="color: rgb(245, 210, 12); font-size: 12px; "
                            height="1em" viewBox="0 0 16 16" class="bi bi-star-fill" fill="currentColor"
