...
@section('newAddressForm')

    <div class="container">
        <form action="/NuevaDireccion" method="POST" class="forms">
        @csrf 
        ...
        <div class="myForms" style="width: 35em; margin-left: 26%; border: 2px solid #007bff">
            <div class="myFormData">
                <div>
                    <span style="font-size: 26px;"> <strong> NUEVA DIRECCIÓN</strong></span> 
                    <strong>
                    <a 
                        class="text-muted" 
                        data-toggle="tooltip" 
                ...
                <input type="text" name="primary" value="1" hidden>
                @else
        ...
        <div class="newbiz ">
            <label class="" for="nombreCompleto"><strong>Nombre Completo*</strong>
                ...
                <div class="control">
                    <input class="form-control @error('nombreCompleto') is-invalid @enderror" name="nombreCompleto" id="nombreCompleto" type="text" placeholder="Nombre Completo" value="{{old('nombreCompleto')}}" maxlength="120" required>
        ...
        <div class='row' >
            <div class='newbiz col'>
                ...
                <div class="newbiz col" >
                    ...
                    <input class="form-control @error('codigoPostal') is-invalid @enderror" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" maxlength="5" name="codigoPostal" value="{{old('codigoPostal')}}" placeholder="Código Postal">
        ...
        <div class="newbiz ">
            <label class="" for="dir"><strong>Dirección*</strong></label>
                <div class="control">
                    <input class="form-control @error('dir') is-invalid @enderror" name="dir" id="dir" type="text" placeholder="Dirección donde entregar el paquete" value="{{old('dir')}}" required>
                
                </div>
        </div>
        <br> 
        <div class="newbiz ">
            <label class="" for="infoAdicional"><strong>Información Adicional<small class="text-muted">(opcional)</small></strong> <a 
                class="text-muted"
                style=" text-decoration:none;" 
                data-toggle="tooltip" 
                data-placement="right" 
                ...
                <div class="control">
                    <textarea class="form-control @error('infoAdicional') is-invalid @enderror" name="infoAdicional" id="infoAdicional" placeholder="Información adicial que nos ayude a encontrar la Dirección." value="{{old('infoAdicional')}}">  </textarea>
