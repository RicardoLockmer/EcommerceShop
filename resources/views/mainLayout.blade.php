    ...
    <div class="navbar navbar-expand-lg navbar-dark bg-dark justify-content-between">
        ...
        <ul class="navbar-nav">
            ...
            <form autocomplete="off" action="/search" method="POST" role="search" class="form-inline">
                @csrf
                <input style="margin-left: 15px;" autocomplete="off" class="form-control mr-sm-2" name="q"
                    placeholder="Buscar">
                <button class="btn" type="submit">
                    <svg style="color:white; margin-left:-15px; font-size: 24px;" width="1em" height="1em"
            ...
            <li class="nav-item">
                <a class="nav-link" href="/ShoppingCart">
                    <svg style="color: white; font-size: 20px;" width="1em" height="1em" viewBox="0 0 16 16"
            ...
            @if(Auth::user()->nombreNegocio != NULL)
            <li class="nav-item">
                <a class="nav-link" href="/negocio/{{Auth::user()->nombreNegocio}}"
            ...
            @else
            <li class="nav-item">
                <a class="nav-link" href="/iniciar-mi-negocio"
                    style="border: 1px solid rgb(192, 192, 192);  border-radius: 5px; ">
                    Como Vender
                </a>
            </li>
